...
const FLOWLOG_READERS: Record<string, number> = {
  ...
  "tests/modules/chatwoot-monitoring-seam.test.ts": 3,
  ...
  "tests/modules/delivery-sweep.test.ts": 4,
  "tests/modules/eager-media-flow-context.test.ts": 3,
  ...
  "tests/modules/spend-ceiling-poll.test.ts": 5,
