...
// default without these two rows would be a fleet-wide cost increase nobody could see. Both tests go
// through the real runAgentTurn and read the rows the operator would read.
  ...
  beforeAll(async () => {
    ...
    await suDb.chatwootAgentBot.create({
      data: {
        ...
        webhookRouteTokenHash: `ttsnorm-route-${process.pid}`,
        name: "Atendente",
      },
    });
