...
// carry the same fields. 450 characters on 24,748. Trimmed first, by 100: the clause says what the
// action does and the field only what the type cannot (that empty is a choice, and the cap).
// Re-measured on the tree that ships: 25,198.
